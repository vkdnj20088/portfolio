...
> 테스트 6개**(렌더 성능 라운드)가 앱 계층에 추가됐습니다. 현재 최종 수치는 **단위 73개(도메인 35 + 앱 30 +
> UI 8) + e2e 3개(Playwright, 스크롤 앵커링/reduced-motion - jsdom 이 못 재는 것만 실브라우저로)**
> 입니다.
...
- 단위 45개: `@chat/search-domain` 25(토크나이즈 불변식/결정성/키워드-시맨틱 대비/추출 span/근거 검증/
