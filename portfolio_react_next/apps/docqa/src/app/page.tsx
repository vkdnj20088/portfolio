      ...
      <div className="page">
        <div className="pageHead">
          ...
          <p>
            ...
            원문에서 오려내므로 <b>없는 말을 지어내지 않고</b>, 근거가 약하면 답하지 않습니다. 다만
            근거 문장을 잘못 고를 수는 있어, 그 비율까지 <a href="/eval">품질 지표</a>에 공개합니다.
          </p>
        </div>
        ...
        <p className="samplesHint">
          뒤쪽 두 개는 <b>코퍼스에 답이 없는 질문</b>입니다. 그럴듯한 문장을 내미는 대신 답하지
          않는지 확인해 보세요.
        </p>
            ...
            <div className="answerBody" aria-busy={status === 'streaming'}>
              ...
              {status === 'none' && (
                <span className="noAnswer">
                  이 질문에 답할 근거를 코퍼스에서 찾지 못했습니다. 그럴듯한 문장을 지어내는 대신
                  답하지 않습니다.
                </span>
              )}
              {status === 'error' && (
